...
describe("TypeScript Koans - Test Suite 1", () => {
  it("Immutability in TypeScript", () => {
    ...
    // NOTE: this test is not necesary, since the name doesnt change because name is a readonly attribute
    // expect(person.name).toEqual('Alice');
...
describe("TypeScript Koans - Test Suite 2", () => {
  it("Async functions and promises in TypeScript", async () => {
    ...
    userData = await fetchUserData(2);
    ...
    // Failing Test 3: Uncomment the expect statements below and provide the expected values
    // NOTE: here, fetchUserData take 100ms to complete the promise and the promise of "Winner" takes 50ms
...
describe("TypeScript Koans - Test Suite 4", () => {
  it("Narrowing types in TypeScript", () => {
    ...
    expect(logType(Number(true))).toEqual("It's a number: 1");
    ...
    function makeSound(animal: Dog | Cat): string {
      ...
      // NOTE: this return would be very difficult or maybe a "never" return since the params are only Dog and Cat
      return "sound";
    }
    // Failing Test 2: Uncomment the expect statement below and provide the expected value
    const dog = new Dog();
    expect(makeSound(dog)).toEqual("Woof! Woof!");
    const cat = new Cat();
    ...
    expect(stringifyIfObject({ demo: "hi" })).toEqual('{"demo":"hi"}');
  });
});
...
describe("TypeScript Koans - Test Suite 5", () => {
  it("should understand union and intersection types in TypeScript", () => {
    ...
    ).toEqual({ name: "John", age: 30, company: "ABC", position: "Developer" });
    ...
    expect(printStringOrNumber(2)).toEqual("The input is a number: 2");
