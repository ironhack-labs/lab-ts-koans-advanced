...
describe("TypeScript Koans - Test Suite 4", () => {
  ...
  it("should log correct type for number", () => {
    expect(logType(42)).toEqual("It's a number: 42");
  });

  // Failing Test 2: Uncomment the expect statement below and provide the expected value
  it("should log correct type for string", () => {
    expect(logType("hello")).toEqual("It's a string: hello");
  });
  ...
  it("should make correct sound for Dog", () => {
    expect(makeSound(new Dog())).toEqual("Woof! Woof!");
  });
  ...
  // Failing Test 4: Uncomment the expect statement below and provide the expected value
  it("should stringify object if input is an object", () => {
    expect(stringifyIfObject({ name: "Alice", age: 28 })).toEqual(
      '{"name":"Alice","age":28}'
    );
  });
});
